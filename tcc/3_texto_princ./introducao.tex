...
\textbf{Objetivo geral}: Implementar uma \textit{engine} com modelagem orientada a dados 
na linguagem de programação Rust e analisar sua eficiência e desempenho.\\
