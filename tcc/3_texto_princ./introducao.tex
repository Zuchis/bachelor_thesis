...
em torno do problema e suas possíveis soluções, e não em torno dos dados. Ou seja, forne abstração dos dados porém a 
custo do desempenho.
...
são responsáveis por administrar toda a parte lógica de uma aplicação gráfica, separando-a em diferentes componentes utilizando bibliotecas, 
que por vezes também são conhecidos como componentes núcleo, e fornecem utilidades que aceleram o processo de desenvolvimento 
...
desenvolvimento de uma engine na linguagem de programação Rust e analisar sua 
...
\begin{itemize}
    ...
    \item Analisar o desempenho da \textit{engine}, através do desenvolvimento de uma 
