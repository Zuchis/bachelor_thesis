...
cobertura de toda a matemática essencial utilizada em motores de jogos.
...
\begin{table}[h!]
\centering
\caption{Tempo médio de execução das funções para a versão OO.}
\label{oodv1table}
\begin{tabular}{ccccccc}
                                      & \multicolumn{2}{c}{Draw}                                     & \multicolumn{2}{c}{Att. objetos}                             & \multicolumn{2}{c}{Verif. colisões}        \\
\multicolumn{1}{l}{Número de objetos} & \multicolumn{1}{l}{Média} & \multicolumn{1}{l}{Desv. padrão} & \multicolumn{1}{l}{Média} & \multicolumn{1}{l}{Desv. padrão} & Média   & \multicolumn{1}{l}{Desv. padrão} \\
...
\begin{table}[h!]
\centering
\caption{Tempo médio de execução das funções para a versão OD.}
\label{dodv1table}
\begin{tabular}{ccccccc}
                                      & \multicolumn{2}{c}{Draw}                                     & \multicolumn{2}{c}{Att. objetos}                             & \multicolumn{2}{c}{Verif. colisões}                \\
\multicolumn{1}{l}{Número de objetos} & \multicolumn{1}{l}{Média} & \multicolumn{1}{l}{Desv. padrão} & \multicolumn{1}{l}{Média} & \multicolumn{1}{l}{Desv. padrão} & Média           & \multicolumn{1}{l}{Desv. padrão} \\
