...
também para controlar a renderização destes através da chamada da função \textit{draw}. 
...
propriedades da versão orientada a objetos, isso significa que os objetos foram 
decompostos em propriedades alocadas em \textit{arrays} separadamente. A raiz do grafo 
