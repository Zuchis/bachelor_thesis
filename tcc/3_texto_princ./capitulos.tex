...
100                                   & 0.62ms                    & 0.05                             & 0.04ms                    & 0.005                            & $6 x 10^{-3}$ms & $7 x 10^{-3}$                    \\
200                                   & 1.04ms                    & 0.01                             & 0.08ms                    & 0.003                            & 0.001ms         & $2 x 10^{-3}$                    \\
400                                   & 1.96ms                    & 0.05                             & 0.20ms                    & 0.01                             & 0.002ms         & 0.001                            \\
800                                   & 3.84ms                    & 0.05                             & 0.40ms                    & 0.03                             & 0.004ms         & 0.002                            \\
1600                                  & 7.65ms                    & 0.06                             & 0.7ms                     & 0.01                             & 0.008ms         & $2 x 10^{-3}$                    \\
3200                                  & 15.28ms                   & 0.1                              & 1.33ms                    & 0.01                             & 0.016ms         & $6 x 10^{-3}$
\end{tabular}
\end{table}

\section{Problema B: renderização de objetos com três níveis de hierarquia}
