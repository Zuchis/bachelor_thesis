...
causa tal comportamento, instruções com condicionais são exemplos 
de instruções que causam \textit{branching}.
...
para o cache antes que seja necessário usá-los~\cite{smith1982}
...
Neste capítulo será explicada a proposta deste trabalho, um motor de jogos com modelagem 
orientada a dados visando à otimização da comunicação entre o processador e a memória.
