...
atingir esses objetivos através de abstrações sem custo, utilização de um sistema de 
...
literatura que cobre a área de arquitetura de motor de jogos. Além disso, não há material 
...
de jogos, ainda falta ser decidido quais as métricas de desempenho que serão empregadas 
